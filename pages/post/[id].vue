                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3 pt-0.5">
                        ...
                        <div class="text-[13px] -mt-5 font-light">
                            ...
                            <span class="font-medium">{{ $generalStore.selectedPost.user.created_at }}</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            <div class="text-[18px] font-semibold flex items-center justify-between">
                                ...
                                <Icon 
                                    ...
                                    @click="$event => deleteComment($generalStore.selectedPost, comment.id)" 
...
const addComment = async () => {
    try {
        ...
        comment.value = null
        document.querySelector('#Comments').scroll({top: 0, behavior: 'smooth'})
    } catch (error) {
        console.log(error)
    }
}
