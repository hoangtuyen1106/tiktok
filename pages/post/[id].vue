    ...
    <div id="PostPage"
        ...
        <div class="lg:w-[calc(100%-540px)] h-full relative">
            <NuxtLink class="absolute z-20 m-5 rounded-full bg-gray-700 p-1.5 hover:bg-gray-800">
                <Icon name="material-symbols:close" style="color: #ffffff" size="27" class="block" />
            </NuxtLink>
            <div v-if="true">
                <button :disabled="!isLoaded" @click="$event => loopThroughPostsUp()"
                    ...
                    <Icon name="mdi:chevron-up" size="30" class="block text-white" />
                </button>
                <button :disabled="!isLoaded" @click="$event => loopThroughPostsDown()"
                    ...
                    <Icon name="mdi:chevron-down" size="30" class="block text-white" />
                </button>
            </div>
            ...
            <video v-if="true" class="absolute object-cover w-full my-auto z-[-1] h-screen" src="/237249_small.mp4" />

            <div v-if="!isLoaded" class="flex items-center justify-center bg-black bg-opacity-70 h-screen lg:min-w-[480px]">
                <Icon class="animate-spin ml-1 block text-white" name="mingcute:loading-line" size="100" />
            </div>
            <div class="bg-black bg-opacity-70 lg:min-w-[480px]">
                <video v-if="true" ref="video" loop muted class="h-screen mx-auto" src="/233037_small.mp4" />
            </div>
        </div>
        <div id="InfoSection" v-if="true" class="lg:max-w-[550px] relative w-full h-full bg-white">
            ...
            <div class="flex items-center justify-between px-8">
                ...
                <Icon v-if="true" @click="$event => deletePost()" class="cursor-pointer block"
            ...
            <div class="px-8 mt-4 text-sm font-bold">
                <Icon name="mdi:music" size="17" class="inline-block align-middle" />
                original sound - User name
            </div>
            <div class="flex items-center px-8 mt-8">
                <div class="pb-4 text-center flex items-center">
                    <button class=" rounded-full bg-gray-200 p-2 cursor-pointer">
                        <Icon name="mdi:heart" size="25" class="block" />
                    </button>
                ...
                <div class="pb-4 text-center flex items-center">
                    <div class=" rounded-full bg-gray-200 p-2 cursor-pointer">
                        <Icon name="bx:bxs-message-rounded-dots" size="25" class="block" />
                    </div>
                    <span class="text-xs pl-2 pr-4 text-gray-800 font-semibold">
                        123
                    </span>
                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            ...
                            <div class="text-[15px] font-light">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum animi maxime maiores
                                reprehenderit harum reiciendis neque dignissimos nobis, nesciunt voluptatum quia, alias
                                illum quidem repellendus totam, vitae porro cupiditate earum?
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="CreateComment" v-if="true"
                ...
                <div :class="inputFocused ? 'border-2 border-gray-400' : 'border-2 border-[Ff1F1F2]'"
                    ...
                    <input v-model="comment" @focus="$event => inputFocused = true"
                        ...
                        class="bg-[#F1F1F2] text-[14px] focus:outline-one w-full lg-max-w-[420px] p-2 rounded-lg"
