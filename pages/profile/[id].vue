        ...
        >
            <div class="flex w-[calc(100%-230px)]">
                ...
                <div class="ml-5 w-full">
                    ...
                    <button 
                        ...
                        class="flex item-center rouded-md py-1.5 px-3.5 mt-3 text-[15px] font-semibold border hover:bg-gray-100">
            ...
            <div class="w-full flex items-center pt-4 border-b">
                ...
                <div class="w-60 text-gray-500 text-center py-2 text-[17px] font-semibold">
                    <Icon name="material-symbols:lock-open" class="-mb-0.5" /> Linked
                </div>
            </div>
